  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      <SheetTrigger asChild>
        <button
          type="button"
          className={`h-[22px] inline-flex items-center gap-1.5 px-3 rounded-full border text-[12px] font-medium cursor-pointer transition-colors ${selectedName ? 'border-[#3B2FB1]/30 bg-[#3B2FB1]/10 text-[#3B2FB1]' : 'border-slate-200 bg-white text-slate-500 hover:bg-slate-50'}`}
        >
